...
import { WHATSAPP_SUPPORT_URL, makeWhatsAppMessageUrl } from "@/lib/constants";

export const metadata = {
  title: "Atlas PRO TV numérique - Offres 2025 | Solo, Duo, Famille",
  description:
    "Comparez les offres officielles Atlas PRO TV numérique : Solo, Duo et Famille. Streaming 4K stable, activation instantanée et support 24/7.",
  alternates: {
    canonical: "/offres-tv-numerique/forfait-4k",
  },
};
...
const faqItems = [
  {
    question: "Les codes Atlas PRO TV numérique sont-ils officiels ?",
    answer:
...
export default function Page() {
  return (
    <div className="space-y-16">
      <Breadcrumbs items={[{ label: "Forfait 4K", href: "/offres-tv-numerique/forfait-4k" }]} />

      <PageHero
        badge="Offres Atlas PRO TV numérique 2025"
        title="Découvrez nos packs officiels Atlas PRO TV numérique"
        description="Solo, Duo ou Famille : choisissez votre formule TV numérique 4K avec activation instantanée et support prioritaire."
        primaryCta={{
          label: "Commander maintenant",
          href: WHATSAPP_SUPPORT_URL,
          trackingLabel: "Offres TV numériques - WhatsApp Achat",
        }}
        image={{
          src: "/images/abonnement-tv-numerique-france.webp",
          alt: "Packs officiels Atlas PRO TV numérique 4K",
          width: 960,
          height: 640,
        }}
      />
...
<section id="offres" className="relative bg-[#0f0f15] py-20 text-white">
  ...
  <div className="container mx-auto px-4 text-center">
    <SectionHeading
      eyebrow="Nos Offres TV numériques Officielles"
    ...
    <div className="mt-16 grid gap-8 md:grid-cols-3">
      ...
      <div className="group relative flex flex-col rounded-3xl bg-gradient-to-br from-gray-900 to-black p-8 shadow-lg transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl">
        ...
        <ul className="mb-8 space-y-2 text-sm text-gray-200 text-left">
          <li>?? 1 Code (1 appareil simultané)</li>
          <li>?? Code officiel & certifié</li>
          <li>?? Livraison instantanée</li>
          <li>?? Paiement 100% sécurisé</li>
          <li>?? Support WhatsApp vérifié 24/7</li>
        </ul>

        <CTAButton
          href={makeWhatsAppMessageUrl(
            "Bonjour Atlas PRO TV numérique, je souhaite acheter le pack Solo.",
          )}
          variant="gold"
      ...
      <div className="group relative flex flex-col rounded-3xl bg-gradient-to-br from-[#7e22ce] to-[#a855f7] p-8 shadow-lg transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl">
        ...
        <ul className="mb-8 space-y-2 text-sm text-gray-100 text-left">
          <li>?? 2 Codes (2 appareils simultanés)</li>
          <li>?? Codes officiels & certifiés</li>
          <li>?? Garantie de remplacement</li>
          <li>?? Livraison instantanée</li>
          <li>?? Support WhatsApp vérifié 24/7</li>
        </ul>
        ...
        <CTAButton
          href={makeWhatsAppMessageUrl(
            "Bonjour Atlas PRO TV numérique, je souhaite acheter le pack Duo.",
          )}
          variant="purple"
      ...
      <div className="group relative flex flex-col rounded-3xl bg-gradient-to-br from-[#4f46e5] to-[#3b82f6] p-8 shadow-lg transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl">
        ...
        <ul className="mb-8 space-y-2 text-sm text-gray-100 text-left">
          <li>?? 3 Codes (3 appareils simultanés)</li>
          <li>?? Codes officiels & certifiés</li>
          <li>?? Garantie de remplacement</li>
          <li>?? Livraison instantanée</li>
          <li>?? Support WhatsApp vérifié 24/7</li>
        ...
        <CTAButton
          href={makeWhatsAppMessageUrl(
            "Bonjour Atlas PRO TV numérique, je souhaite acheter le pack Famille.",
          )}
          variant="purple"
      ...
      <InternalLinks
        ...
        description="Installation, assistance et comparatifs pour profiter pleinement d'Atlas PRO TV numérique."
        links={[
          {
            href: "/offres-tv-numerique/forfait-premium",
          ...
          },
          {
            ...
            label: "Installer Atlas PRO TV numérique sur Smart TV",
          ...
          },
          {
            ...
            label: "Solutionner les erreurs de connexion TV numérique",
            description: "Checklist officielle pour débloquer votre compte en quelques minutes.",
            category: "Support",
          },
          {
            href: "/blog/tv-numerique-4k-2025",
            label: "Lire le guide TV numérique 4K 2025",
      ...
      <section className="container space-y-10">
        <SectionHeading
          eyebrow="FAQ Atlas PRO TV numérique"
          title="Questions fréquentes sur les packs Atlas PRO TV numérique"
          description="Toutes les réponses concernant les codes, activations et compatibilités."
          align="center"
        />
        <FAQBlock items={faqItems} />
        <FAQSchema items={faqItems} canonical="/offres-tv-numerique/forfait-4k" />
      </section>
    </div>
  );
}
